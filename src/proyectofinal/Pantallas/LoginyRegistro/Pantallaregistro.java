...
import proyectofinal.Pantallas.AntVersion;
...
public class Pantallaregistro extends javax.swing.JFrame {
    ...
    private void btnregActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnregActionPerformed
        ...
        if (username.isEmpty() || password.isEmpty() || correo.isEmpty()) {
        ...
        } else if (username.length() <= 3 || password.length() <= 3 || correo.length() <= 3) {
            ...
            registro(username, password, correo);
        }
    ...
    private void registro(String username, String password, String correo) {
        try {
            JSONObject RegisterResult = UserClient.register(username, password,correo);
