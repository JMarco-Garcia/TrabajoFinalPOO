...
public class UserClient {
    ...
    public static JSONObject register(String username, String password, String correo) throws Exception {
    ...
    public static JSONObject getPuntosByKey(String address) {
        ...
        try {
            String jsonResponse = sendGetRequest("getPuntosByKey.php?key=" + URLEncoder.encode(address, "UTF-8"));
