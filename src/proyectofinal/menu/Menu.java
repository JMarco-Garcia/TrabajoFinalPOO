...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("favorito", "Favoritos", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("filtrar", "Filtrar", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("editar", "Editar", Model_Menu.MenuType.MENU));
        //listMenu1.addItem(new Model_Menu("", "Usuario", Model_Menu.MenuType.TITLE));
